        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xs-12">
                <div class="left-text-content">
                    <p>© Copyright Man I Love Firefox team
                </div>
            </div>
        </div>
    </div>
...
<script src="assets/datepicker/dist/js/locales/en-GB.js"></script>
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/imgix.js/3.4.2/imgix.min.js"></script>
